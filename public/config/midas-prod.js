  ...
  servers: [
    {
      ...
      url: "https://pgids.midaspacs.in/dcm4chee-arc/aets/DCM4CHEE/rs",
      upgradeInsecureRequests: true, // Enable automatic HTTP -> HTTPS upgrade
      write: true,
    },
  ],
  oidc: {
    authority: "https://pgids.midaspacs.in/auth/realms/midas", // ${OIDC_AUTHORITY}",
    clientId: "pacs-ui", //${OIDC_CLIENT_ID}",
    scope: "openid profile email",
    grantType: "authorization_code",
    endSessionEndpoint:
      "https://pgids.midaspacs.in/auth/realms/midas/protocol/openid-connect/logout", //${OIDC_LOGOUT}",
  },
